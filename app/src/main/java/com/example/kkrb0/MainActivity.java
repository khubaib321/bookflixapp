...
public class MainActivity extends AppCompatActivity
    ...
    public static final String EXTRA_MESSAGE = "com.example.kkrb0.MESSAGE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridview.setOnItemClickListener((parent, view, position, id) -> {
            ...
            TextView bookName = view.findViewById(R.id.textview_book_name);
            String message = bookName.getText().toString();
